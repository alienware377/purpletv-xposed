...
object PurpleMenu {
    ...
    private val CHAT = listOf(
        ...
        Drop("/me Style", "", "me_style",
            listOf("Disabled", "Colored", "Italic", "Italic + Colored")),
        Drop("Deleted messages", "Choose how deleted messages are handled in the chat",
            "deleted_messages", listOf("Default", "Mod", "Strikethrough", "Grey")),
    ...
    private val PLAYER = listOf(
        ...
        Toggle("Hide Unfollow button", "", "hide_unfollow_button"),
        Toggle("Hide \"Follow/Subscribe\" button", "", "hide_fsb"),
        Toggle("Hide \"Create clip button\"", "", "hide_player_create_clip_button"),
        Toggle("Hide \"Share button\" for Live streams", "", "hide_player_live_share_button"),
        Toggle("Disable chromecast", "", "disable_cast"),
    ...
    private val VIEW = listOf(
        ...
        Toggle("Hide \"Discovery feed\"", "", "hide_discover_feed"),
        ...
        Toggle("Hide \"Create\" button", "", "hide_create_button"),
